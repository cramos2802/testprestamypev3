...
public class Aprobar_inversionista {

    WebDriver driver;

    @Dado("realizo la busqueda del nombre del inversionista por nombre corroborar que esta en la seccion aprobado")
    public void realizo_la_busqueda_del_nombre_del_inversionista_por_nombre_corroborar_que_esta_en_la_seccion_aprobado() {
        ...
        driver.findElement(By.xpath("//*[@id=\"__layout\"]/div/div/div[2]/div/div[2]/div[1]/ul/li[2]")).click();
